// 3.26 LAB: Expression for calories burned during workout
...
int main() {
   ...
   cin >> age >> weight >> heart >> tTime;
   
   double calories = ((age * 0.2757) + (weight * 0.03295) + (heart * 1.0781) - 75.4991 ) * tTime / 8.368;
